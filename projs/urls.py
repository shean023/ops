...
urlpatterns = [
    ...
    path(r'ticket_list/', views.ticket_list, name='ticket_list'),
    ...
    re_path(r'read_branch/(?P<pk>[0-9]+)/', views.read_branch, name='read_branch'),
    ...
    re_path(r'deploy_ticket/(?P<pk>[0-9]+)/', views.deploy_ticket, name='deploy_ticket'),
    re_path(r'ticket_list/', views.ticket_list, name='ticket_list'),
]
