...
class Assets(models.Model):
    ...
    asset_cabinet = models.ForeignKey('Cabinet', related_name='assets', null=True, blank=True, verbose_name='所在机柜',
                                      on_delete=models.PROTECT)
    asset_platform = models.ForeignKey('PlatformName', related_name='assets', null=False, blank=False, verbose_name='所属平台',
                                      on_delete=models.PROTECT)
    asset_proj = models.ForeignKey('ProjectName', related_name='assets', null=False, blank=False, verbose_name='所属项目',
                                      on_delete=models.PROTECT)
...
class ProjectEnv(models.Model):
    ...
    projenv_memo = models.CharField(max_length=128, blank=True, null=True, verbose_name='备注')
...
class PlatformName(models.Model):
    ...
    platform_memo = models.CharField(max_length=128, blank=True, null=True, verbose_name='备注')
...
class ProjectName(models.Model):
    """项目名称"""
    platformname = models.ManyToManyField('PlatformName', related_name='projectname', blank=True, verbose_name='所属平台')
    ...
    projname_memo = models.CharField(max_length=128, blank=True, null=True, verbose_name='备注')
...
class ProjectApp(models.Model):
    """应用表"""
    projectname = models.ForeignKey('ProjectName', related_name='projectapp', on_delete=models.CASCADE)
    projapp_name = models.CharField(max_length=64, unique=False, verbose_name='应用名称')
    projapp_memo = models.CharField(max_length=100, blank=True, null=True, verbose_name='备注')
