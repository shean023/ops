...
router.register(r'projenv', views.ProjenvViewSet)
router.register(r'platform', views.PlatformNameViewSet)
router.register(r'projname', views.ProjnameViewSet)
router.register(r'projapp', views.ProjappViewSet)
router.register(r'project_config', views.ProjectConfigViewSet)
router.register(r'proj_ticket', views.ProjTicketViewSet)
router.register(r'deploy_ticket', views.DeployTicketViewSet)
router.register(r'confd', views.ConfdViewSet)
router.register(r'confd_detail', views.ConfdDetailViewSet)
